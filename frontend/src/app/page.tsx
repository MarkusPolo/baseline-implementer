  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex gap-4">
        ...
        <Link href="/templates/new" className="flex items-center gap-2 rounded-lg bg-neutral-800 px-4 py-2 text-sm font-semibold text-neutral-200 hover:bg-neutral-700 transition-colors border border-neutral-700">
